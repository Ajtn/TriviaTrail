...
function App() {
  ...
  //Set window width until feature is fully implemented
  ...
  const apiDetails = {baseUrl: "https://the-trivia-api.com/v2/questions", method: "GET", headers: {}, urlParams: ["limit=25", "difficulties=easy"]};
  return (
    <div className='app'>
